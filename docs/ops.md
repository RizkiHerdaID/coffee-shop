# Operations — Coffee Shop

Production and ops tooling for the coffee-shop codebase: local services, mail,
queues, production notes, uptime monitoring, and database backups.

See `README.md` at the repo root for setup and feature overviews.
