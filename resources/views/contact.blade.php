...
<section class="mx-auto max-w-4xl px-4 pt-32 pb-20 sm:px-6 sm:pt-40">
    ...
    <div class="mt-12 grid gap-8 sm:grid-cols-2">
        ...
        <div class="rounded-2xl border border-stone-800 bg-stone-900/60 p-8">
            ...
            <a href="https://wa.me/{{ preg_replace('/\D/', '', config('shop.phone')) }}?text={{ urlencode(config('shop.wa_message')) }}" target="_blank" rel="noopener" class="mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-500 px-6 py-2.5 text-sm font-semibold text-stone-950 transition hover:bg-emerald-400">
    ...
    <div class="mt-8 flex flex-col items-center gap-6 rounded-2xl border border-stone-800 bg-stone-900/60 p-8 text-center sm:flex-row sm:text-left">
        ...
        <div>
            <h2 class="text-lg font-semibold text-white">Terima QRIS</h2>
